...
# Instance created: title, storyline, movie image and movie trailer.
a_beautiful_mind = media.Movie("A Beautiful Mind",
    """A human drama inspired by events in the life of
    mathematical genius, John Forbes Nash Jr.""",
    "https://images-na.ssl-images-amazon.com/images/I/71AHkwimfJL._SY550_.jpg",  # Noqa
...
lucy = media.Movie("Lucy",
    """A woman, accidentally caught in a dark deal, turns the tables on
    her captors and transforms into a merciless warrior evolved beyond
    human logic.""",
    "https://upload.wikimedia.org/wikipedia/en/1/14/Lucy_%282014_film%29_poster.jpg",  # Noqa
    "https://www.youtube.com/watch?v=MVt32qoyhi0"
    )

# Movie: A Wonder Woman
# Instance created: title, storyline, movie image and movie trailer.
...
the_notebook = media.Movie("The Notebook",
    """In 1940s South Carolina mill worker Noah Calhoun
    (Ryan Gosling) and rich girl Allie (Rachel McAdams)
    are desperately in love.But her parents don't approve.
    When Noah goes off to serve in World War II, it seems to
    mark the end of their love affair. In the interim, Allie becomes
    involved with another man. But when Noah returns to their small
...
# Instance created: title, storyline, movie image and movie trailer.
rv = media.Movie("RV",
    """The Munro's are a typically American dysfunctional family,
    complete with rebellious, uncommunicative offspring
    and baffled parents. Patriarch Bob would like to remedy the
    situation before his son and daughter instant-message their
    parents out of their lives. Bob rents a motor
    home to take the clan on vacation but soon finds that
    camping and togetherness can be hazardous to one's health""",
    "https://upload.wikimedia.org/wikipedia/en/0/0f/Rv-movieposter.jpg",  # Noqa
    "https://www.youtube.com/watch?v=QkZXAB-RdbI"
    )

# Variable movies created to include
# an array of all movies to be initialized
# from import fresh_tomatoes

movies = [
    a_beautiful_mind, lucy, wonder_woman,
